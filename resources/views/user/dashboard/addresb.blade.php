                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-6">
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="posteresp" id="inlineRadio1" value="Directeur Général" onclick="myFunction2()">
                                    <label class="form-check-label" for="inlineRadio1"> Directeur Général </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="posteresp" id="inlineRadio1" value="Directeur" onclick="myFunction2()">
                                    <label class="form-check-label" for="inlineRadio1"> Directeur </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="posteresp" id="inlineRadio1" value="Gérant" onclick="myFunction2()">
                                    <label class="form-check-label" for="inlineRadio1"> Gérant </label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="posteresp" id="inlineRadio1"  onclick="myFunction()">
                            ...
                            <div class="form-group row">  
                                <div class="col-6">
                                    <input type="text" class="form-control form-control-user" id="exampleFirstName" name="tel" placeholder="Telephone ">
                                </div>
                                <div class="col-6">
                                    <input type="text" class="form-control form-control-user" id="exampleFirstName" name="fax" placeholder="Fax ">
                                </div>
                            </div>
                            <div class="form-group row">  
                                <div class="col-6">
                                    <label for=""> Vous voulez vontre contact </label>
                                </div>
                                <div class="col-6">
                                    <div class="form-check form-check-inline">

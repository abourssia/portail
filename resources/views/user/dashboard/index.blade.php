                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                <a href="{{ url('user/dashboard/add')}}" class="nav-link disabled">
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="{{ url('user/dashboard/1/update')}}" class="nav-link ">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                ...
                                                <a href="{{ url('user/dashboard/add')}}" class="nav-link">
                                               <p>  Ajouter une Entreprise  </p>
                                                </a>
                                ...
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            ...
                                            <a href="{{ url('user/dashboard/1/update')}}" class="nav-link disabled">
                                               <p>   Modifier Votre Entreprise </p>
                                                </a>
                            ...
                            <div class="card border-left-primary shadow h-100 py-2">
                                <div class="card-body">
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                            <a href="{{ url('user/dashboard/responsable')}}">

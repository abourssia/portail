...
<!-- Content Row -->
    ...
    @csrf
          ...
          <div class="form-group row">
                ...
                <div class="form-group row">
                    <div class="col-sm-12 mb-3 mb-sm-0">
                        <textarea   id="summernote" name="desc" id="" class="form-control"  placeholder="DESC  de l’entreprise "  ></textarea>
                    </div>
                </div>
                <div class="image">
          ...
          <div class="card-footer">
            <div class="form-group">
                <button type="submit" class="btn btn-primary" style="margin-left:250px">AJOUTER</button>
            </div>
        </div>
    </div>
